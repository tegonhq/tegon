        ...
        <ScrollArea className="w-full h-full">
          ...
          <div className="px-6">
            ...
            <p className="mt-2">
              ...
              organize list of tasks, collaborate, and track progress
              effectively. However, existing tools often introduce the following
              challenges:
            </p>
            <ul className="list-disc ml-6">
              ...
              <li>
                Existing tools don&apos;t effectively assist Engineering
                Managers in real-time task, feature, or bug prioritisation.
              </li>
            </ul>
            ...
            <div className="mt-2">
              ...
              <ul className="list-disc ml-6">
                <li>
                  Github: Automatically update issues status based on commits
                  and pull requests and link mentions of issues back to Tegon
                </li>
                <li>
                  Slack: Mention the Tegon bot in a Slack channel to
                  automatically create a bug or feature request. Link a Slack
                  thread to an issue to provide full context about the
                  discussions happening on a specific task or a feature request.
                </li>
                <li>
