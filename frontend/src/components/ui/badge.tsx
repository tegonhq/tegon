...
const badgeVariants = cva(
  'inline-flex items-center h-5 gap-2 rounded border px-2.5 py-0.5 text-xs transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2',
  {
    variants: {
      variant: {
        default:
