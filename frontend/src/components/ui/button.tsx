  ...
  'inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:shadow-none disabled:pointer-events-none disabled:opacity-50 dark:focus-visible:ring-gray-300',
  {
    variants: {
      variant: {
        ...
        outline:
          'border border-gray-100 shadow-sm hover:bg-gray-50 hover:text-gray-800 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700/50 dark:text-gray-50 dark:hover:text-gray-100',
        secondary:
          'bg-gray-100 text-gray-800 shadow-sm hover:bg-gray-50 dark:bg-gray-800 dark:text-gray-50 dark:hover:bg-gray-700/80',
        ghost:
