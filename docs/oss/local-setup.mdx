...
## Local setup for webapp and server

1. Create a `.env` file inside server folder by copying the content from `.env.example` and change values according to your need.
